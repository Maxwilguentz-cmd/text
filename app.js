...
const LS = { tasks:'oslife.tasks', templates:'oslife.templates', events:'oslife.events',
  ...
  coachApiKey:'oslife.coachApiKey', dataUsageLogs:'oslife.dataUsageLogs', dataUsageApps:'oslife.dataUsageApps',
...
function goalMilestoneProgress(g){
  // Objektif Finansye — Pwogrè Finansye a (Sere Deja / Valè Estime) se PWOGRÈ
  // PRENSIPAL la tout tan, kit Objektif la gen Milestones oswa non — paske pou
  // yon Objektif Finansye, se kòb ki sere a ki montre vrè avansman an.
