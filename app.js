...
document.getElementById('txCategory').addEventListener('change', e => updateTxCategoryExtras(e.target.value));
...
function budgetEligibleCats(){
  return EXPENSE_CATS.filter(c => c !== 'Custom' && c !== 'Dlo' && c !== 'Bwason');
}
let budgetDraftCats = [];
